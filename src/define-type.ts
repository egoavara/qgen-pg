...
import { TsSnippet } from './ts-snippet';

export function DefAny(): DefAny { return { category: 'any', type: 'any' } }
export function DefPrimitive(type: "string" | "number" | "bigint" | "boolean" | "symbol" | "undefined"): DefPrimitive { return { category: 'primitive', type } }
export function DefStdlib(type: string): DefStdlib { return { category: 'stdlib', type } }
export function DefObject(type: Record<string, DefType>): DefObject { return { category: 'object', type } }
export function DefExtern(name: string, type: string): DefExtern { return { category: 'extern', name, type } }

export type DefAny = { category: "any", type: "any" }
export type DefPrimitive = { category: "primitive", type: "string" | "number" | "bigint" | "boolean" | "symbol" | "undefined" }
export type DefStdlib = { category: "stdlib", type: string }
export type DefObject = { category: "object", type: Record<string, DefType> }
export type DefExtern = { category: "extern", name: string, type: string }
export type DefTypeInternal = DefAny | DefPrimitive | DefObject | DefStdlib
export type DefTypeExternal = DefExtern
export type DefType = DefTypeInternal | DefTypeExternal
